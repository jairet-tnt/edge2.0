...
import { TrendingUp, List, Menu, UserCircle, Settings, PanelLeft } from "lucide-react";
...
export default function Header({ earnings, sales, onSidebarToggle }: HeaderProps) {
        ...
        <div className="flex items-center gap-3 lg:gap-6 flex-1">
          ...
          {onSidebarToggle && (
            <button
              ...
              className="lg:hidden flex-shrink-0 w-9 h-9 flex items-center justify-center rounded-lg bg-white/15 hover:bg-white/25 transition-colors"
