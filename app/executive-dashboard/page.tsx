        ...
        <div className="bg-white rounded border border-gray-200 p-4 mb-6">
          <div className="flex flex-wrap items-center gap-4">
            <div>
              ...
              <select className="px-3 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-brand-brandBlue min-w-[140px]">
                <option>...</option>
              </select>
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                className="px-3 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-brand-brandBlue w-52"
              />
            </div>
            <div>
              <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">
            ...
            <button className="ml-auto w-10 h-10 flex items-center justify-center rounded-full bg-brand-lightBlue hover:bg-brand-brandBlue text-white transition-colors mt-4">
